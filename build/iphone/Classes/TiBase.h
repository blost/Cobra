...
// in simulator we redefine to format for Cobra Developer console
...
{\
	NSString * exceptionName = [@"org.cobra." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cobra";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UICobraNativeItemNone = -1, 
	UICobraNativeItemSpinner = -2,
	UICobraNativeItemProgressBar = -3,
	
	UICobraNativeItemSlider = -4,
	UICobraNativeItemSwitch = -5,
	UICobraNativeItemMultiButton = -6,
	UICobraNativeItemSegmented = -7,
	
	UICobraNativeItemTextView = -8,
	UICobraNativeItemTextField = -9,
	UICobraNativeItemSearchBar = -10,
	
	UICobraNativeItemPicker = -11,
	UICobraNativeItemDatePicker = -12,
	
	UICobraNativeItemInfoLight = -13,
	UICobraNativeItemInfoDark = -14,
	
	UICobraNativeItemDisclosure = -15,
	
	UICobraNativeItemContactAdd = -16
};
